...
function draw() {
    ...
    for(let i = 0; i < num; i ++) {
        ...
        ellipse((100+ windowWidth/4) - (windowWidth/2) + width /2, height/2 , lowMid, lowMid);
        stroke(lowMid, lowMid, 255, 90)
        fill(0,0)

        ellipse(2*(windowWidth/4)- (windowWidth/2) + width /2,  height/2, mid, mid);
        stroke(mid, mid, 255, 90)
        fill(0,0)

        ellipse(-100+3 *(windowWidth/4)- (windowWidth/2)+ width /2, height/2, highMid, highMid);
        stroke(highMid, highMid, 255, 90)
        fill(0,0)

        ellipse(4 *(windowWidth/4)- (windowWidth/2)+ width /2,height/2, treble, treble);
